...
class Iphone14ProMaxTwoBloc
  ...
  _updateChipView(
    ...
    List<Chipviewfull2ItemModel> newList = List<Chipviewfull2ItemModel>.from(
        state.iphone14ProMaxTwoModelObj!.chipviewfull2ItemList);
    newList[event.index] = newList[event.index].copyWith(
      isSelected: event.isSelected,
    );
    emit(state.copyWith(
        iphone14ProMaxTwoModelObj: state.iphone14ProMaxTwoModelObj
            ?.copyWith(chipviewfull2ItemList: newList)));
  }
  ...
  List<Chipviewfull2ItemModel> fillChipviewfull2ItemList() {
    return List.generate(4, (index) => Chipviewfull2ItemModel());
  }
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
      ...
      chipviewfull2ItemList: fillChipviewfull2ItemList(),
    )));
  }
}
