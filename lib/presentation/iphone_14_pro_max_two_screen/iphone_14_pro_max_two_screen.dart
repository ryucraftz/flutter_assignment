...
import 'models/chipviewfull2_item_model.dart';
import 'models/iphone_14_pro_max_two_model.dart';
import 'widgets/chipviewfull2_item_widget.dart';
...
class Iphone14ProMaxTwoScreen extends StatelessWidget {
        ...
        builder: (context, iphone14ProMaxTwoModelObj) {
          return Wrap(
            ...
            children: List<Widget>.generate(
              iphone14ProMaxTwoModelObj?.chipviewfull2ItemList.length ?? 0,
              (index) {
                Chipviewfull2ItemModel model =
                    iphone14ProMaxTwoModelObj?.chipviewfull2ItemList[index] ??
                        Chipviewfull2ItemModel();
                return Chipviewfull2ItemWidget(
                  model,
  ...
  /// Section Widget
  Widget _buildRowlattefive(BuildContext context) {
    return Align(
      alignment: Alignment.center,
      child: Padding(
        padding: EdgeInsets.only(
