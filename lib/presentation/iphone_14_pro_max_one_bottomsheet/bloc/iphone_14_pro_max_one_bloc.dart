...
class Iphone14ProMaxOneBloc
  ...
  _updateChipView(
    ...
    List<ChipviewfullItemModel> newList = List<ChipviewfullItemModel>.from(
        state.iphone14ProMaxOneModelObj!.chipviewfullItemList);
    newList[event.index] = newList[event.index].copyWith(
      isSelected: event.isSelected,
    );
    emit(state.copyWith(
        iphone14ProMaxOneModelObj: state.iphone14ProMaxOneModelObj
            ?.copyWith(chipviewfullItemList: newList)));
  }
  ...
  List<ChipviewfullItemModel> fillChipviewfullItemList() {
    return List.generate(4, (index) => ChipviewfullItemModel());
  }
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
      ...
      chipviewfullItemList: fillChipviewfullItemList(),
    )));
  }
}
